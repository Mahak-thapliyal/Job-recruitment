...
scaler=pickle.load(open('models/scalerr.pkl', 'rb'))
...
def ana():
    ...
    return render_template('ana.html', df=df.head(),average_satisfaction=average_satisfaction, department_satisfaction=department_satisfaction,salary_satisfaction=salary_satisfaction,
